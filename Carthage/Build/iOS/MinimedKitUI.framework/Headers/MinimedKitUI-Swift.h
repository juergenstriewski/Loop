...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MinimedKitUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12MinimedKitUI37MinimedPumpManagerSetupViewController")
@interface MinimedPumpManagerSetupViewController : RileyLinkManagerSetupViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12MinimedKitUI41RileyLinkMinimedDeviceTableViewController")
@interface RileyLinkMinimedDeviceTableViewController : UITableViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
